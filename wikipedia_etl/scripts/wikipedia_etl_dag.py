...
sys.path.append('/home/liran/Documents/data_engineering/wikipedia_etl/scripts')

# Import the actual processing functions from our existing scripts
from html_to_hdfs import process_files as hdfs_process
from html_to_mysql import process_files, load_config
